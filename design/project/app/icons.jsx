// icons.jsx — SF Symbols–style line icons (Lucide path data, ~2px rounded stroke)
// SF Symbols is proprietary to Apple and cannot be embedded; this is the closest
// open substitute. Documented in README ICONOGRAPHY.
const ICON_PATHS = {
  ...
  battery2: '<rect width="16" height="10" x="2" y="7" rx="2"/><path d="M22 11v2"/><rect width="10" height="6" x="4" y="9" rx="1" fill="currentColor" stroke="none"/>',
  paint: '<circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.9 0 1.7-.7 1.7-1.7 0-.4-.2-.8-.5-1.1-.3-.3-.4-.7-.4-1.1 0-1 .8-1.7 1.7-1.7H16c3.3 0 6-2.7 6-6 0-4.9-4.5-8.7-10-8.7z"/>',
  hand: '<path d="M18 11V6a2 2 0 0 0-2-2a2 2 0 0 0-2 2"/><path d="M14 10V4a2 2 0 0 0-2-2a2 2 0 0 0-2 2v2"/><path d="M10 10.5V6a2 2 0 0 0-2-2a2 2 0 0 0-2 2v8"/><path d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15"/>',
  display: '<rect width="20" height="14" x="2" y="3" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/>',
  lock: '<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',
  shield: '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/>',
  globe: '<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>',
  play: '<polygon points="6 3 20 12 6 21 6 3"/>',
  pause: '<rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/>',
  back: '<path d="M19 20 9 12l10-8z"/><path d="M5 19V5"/>',
  forward: '<path d="m5 4 10 8-10 8z"/><path d="M19 5v14"/>',
  ...
  // --- Running coach additions (Lucide) ---
  run: '<path d="M13 5a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/><path d="M8.5 21 10 15l-2.5-2.5L6 16"/><path d="m10 15 3-1.5 2 2.5 3 1"/><path d="M5 10.5 8 9l3 1 1.5 3"/><path d="m13.5 8.5 2-1 2.5 1.5"/>',
